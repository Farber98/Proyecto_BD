...
?>
        <div id="appendHome">
           <div class="d-flex justify-content-between">
                <div class="mr-auto p-2"><h2 id="titulo_pagina">Agregar falta</h2></div>                             
            </div>
            <form action="./ajax/addFalta.php" method="post">
    ...
    <script type="text/javascript"  src="agregarFalta.js"></script>
</body>
