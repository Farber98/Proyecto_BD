CREATE DEFINER=`root`@`localhost` PROCEDURE `bsp_O5_listar_sueldo_parcial`(pIdAgente int)
BEGIN
/*
...
SELECT 	i.ItemDetalle, i.TipoItem 
...
WHERE 	IdAgente = pIdAgente AND YEAR(s.FechaCobro) = pAnioActual 
